<template>
  <div class="w-full flex flex-wrap">
    <div v-for="plist in playlist" :key="plist.id" class="p-2 w-52 relative">
      <div
      ...
      >
        ...
        >
          <button>
            <a :href="plist.track.external_urls.spotify" target="”_blank”">
...
export default {
  ...
  created() {
    this.newPlaylist = this.playlist;
  },
};
</script>
